 ...
 */
public class PretrainingColumnSelectionComponentGroup extends AbstractGridBagDialogComponentGroup {

    SettingsModelColumnFilter2 m_columnFilterSettings;

    /**
     * Constructor for class PretrainingColumnSelectionComponentGroup using the specified
