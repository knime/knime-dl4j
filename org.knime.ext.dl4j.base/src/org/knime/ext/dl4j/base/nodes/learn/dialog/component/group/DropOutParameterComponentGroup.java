 ...
 */
public class DropOutParameterComponentGroup extends AbstractGridBagDialogComponentGroup {

    SettingsModelNumber m_globalDropOutRateSettings;

    SettingsModelBoolean m_useGlobalDropOutRateSettings;
    ...
    public DropOutParameterComponentGroup(final LearnerParameterSettingsModels2 learnerSettings) {
        ...
        m_globalDropOutRateSettings =
            (SettingsModelNumber)learnerSettings.createParameter(LearnerParameter.GLOBAL_DROP_OUT);
        m_useDropConnectSettings =
    ...
    private void updateEnableStatus() {
        m_globalDropOutRateSettings.setEnabled(m_useGlobalDropOutRateSettings.getBooleanValue());
    }
