 ...
 */
public class FeedforwardClassificationLearnerNodeDialog extends DefaultNodeSettingsPane {
     ...
     */
    protected FeedforwardClassificationLearnerNodeDialog() {
        ...
        addDialogComponent(new DialogComponentColumnNameSelection(
            (SettingsModelString)dataSettingsModels.createParameter(DataParameter.LABEL_COLUMN), "Label Column", 1,
            false, NominalValue.class));
        addDialogComponent(new DialogComponentColumnFilter(
            (SettingsModelFilterString)dataSettingsModels.createParameter(DataParameter.FEATURE_COLUMN_SELECTION), 1,
            true, possibleTypesArray));
    }
}
