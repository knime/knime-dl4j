...
public class FeedforwardLearnerNodeDialog extends DefaultNodeSettingsPane {
    ...
    protected FeedforwardLearnerNodeDialog() {
        ...
        final SettingsModelString trainingModeSettings = (SettingsModelString)learnerSettingsModels.createParameter(
            LearnerParameter.TRAINING_MODE);
        final SettingsModelString labelColumnSettings = (SettingsModelString)dataSettingsModels.createParameter(
            DataParameter.LABEL_COLUMN);
        final SettingsModelFilterString columnSelectionSettings = (SettingsModelFilterString)dataSettingsModels.createParameter(
            DataParameter.COLUMN_SELECTION);
        final SettingsModelIntegerBounded numberOfOutputs = (SettingsModelIntegerBounded)layerSettingsModels.createParameter(
        ...
        final Set<Class<?>> possibleTypes = DataCellToJavaConverterRegistry.getInstance()
        ...
        final Class<? extends DoubleValue>[] possibleTypesArray = (Class<? extends DoubleValue>[]) possibleTypes.toArray(new Class<?>[possibleTypes.size()]);
