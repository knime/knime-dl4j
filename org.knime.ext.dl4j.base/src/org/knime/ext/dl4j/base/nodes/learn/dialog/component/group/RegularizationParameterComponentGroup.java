 ...
 */
public class RegularizationParameterComponentGroup extends AbstractGridBagDialogComponentGroup {

    SettingsModelBoolean m_useRegularizationSettings;

    SettingsModelNumber m_l1Settings;

    SettingsModelNumber m_l2Settings;

    /**
     * Constructor for class RegularizationParameterComponentGroup using the specified
    ...
    public RegularizationParameterComponentGroup(final LearnerParameterSettingsModels2 learnerSettings) {
        ...
        m_l2Settings = (SettingsModelNumber)learnerSettings.createParameter(LearnerParameter.L2);

        addToggleDoubleNumberEditRowComponent(m_useRegularizationSettings, "", m_l1Settings, "L1", m_l2Settings, "L2");

        m_useRegularizationSettings.addChangeListener(new ChangeListener() {
            @Override
    ...
    private void updateEnableStatus() {
        boolean useRegularization = m_useRegularizationSettings.getBooleanValue();
        m_l1Settings.setEnabled(useRegularization);
        m_l2Settings.setEnabled(useRegularization);
    }
