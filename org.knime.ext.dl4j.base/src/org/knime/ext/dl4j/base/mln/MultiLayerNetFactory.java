...
public class MultiLayerNetFactory {
	 ...
	 * @param newDropOut
	 */
	private void overwriteDropOut(List<Layer> layers, double newDropOut){
		for(Layer l : layers){
	 ...
	 * @param newDropOut
	 */
	private void overwriteLearningRate(List<Layer> layers, double newLearningRate){
		for(Layer l : layers){
	 ...
	 * @param newDropOut
	 */
	private void overwriteWeightInit(List<Layer> layers, WeightInit newWeightInit){
		for(Layer l : layers){
	...
	private void init(final LearnerParameterSettingsModels learnerParameters){
		...
		if(intSettings != null) m_seed = intSettings.getIntValue();		
		
		intSettings = learnerParameters.getTrainingIterations();
		if(intSettings != null) m_iterations = intSettings.getIntValue();
		
		SettingsModelBoolean booleanSettings = learnerParameters.getUseSeed();
		if(booleanSettings != null) m_useSeed = booleanSettings.getBooleanValue();
		
		booleanSettings = learnerParameters.getUseGradientNormalization();
		if(booleanSettings != null) m_useGradientNormalization = booleanSettings.getBooleanValue();
		
		booleanSettings = learnerParameters.getUseRegularization();
		if(booleanSettings != null) m_useRegularization = booleanSettings.getBooleanValue();
		
		booleanSettings = learnerParameters.getUseMomentum();
		if(booleanSettings != null) m_useMomentum = booleanSettings.getBooleanValue();
		
		booleanSettings = learnerParameters.getUseDropConnect();
		if(booleanSettings != null) m_useDropConnect = booleanSettings.getBooleanValue();
		
		booleanSettings = learnerParameters.getUseGlobalLearningRate();
		if(booleanSettings != null) m_useGlobalLearningRate = booleanSettings.getBooleanValue();
		
		booleanSettings = learnerParameters.getUseGlobalDropOut();
		if(booleanSettings != null) m_useGlobalDropOut = booleanSettings.getBooleanValue();
		
		booleanSettings = learnerParameters.getUseGlobalWeightInit();
		if(booleanSettings != null) m_useGlobalWeightInit = booleanSettings.getBooleanValue();
		
		booleanSettings = learnerParameters.getUseBackprop();
		if(booleanSettings != null) m_useBackprop = booleanSettings.getBooleanValue();
		...
		if(doubleSettings != null) m_gradientNormalizationThreshold = doubleSettings.getDoubleValue();
		
		doubleSettings = learnerParameters.getL1();
		if(doubleSettings != null) m_l1 = doubleSettings.getDoubleValue();
		
		doubleSettings = learnerParameters.getL2();
		if(doubleSettings != null) m_l2 = doubleSettings.getDoubleValue();
		
		doubleSettings = learnerParameters.getMomentum();
		if(doubleSettings != null) m_momentum = doubleSettings.getDoubleValue();
		
		doubleSettings = learnerParameters.getGlobalLearningRate();
		if(doubleSettings != null) m_learningRate = doubleSettings.getDoubleValue();
