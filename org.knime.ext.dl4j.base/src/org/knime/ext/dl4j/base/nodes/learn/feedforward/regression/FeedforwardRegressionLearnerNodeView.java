 ...
 */
public class FeedforwardRegressionLearnerNodeView extends NodeView<FeedforwardRegressionLearnerNodeModel> {

    // the logger instance
    private static final NodeLogger logger = NodeLogger.getLogger(FeedforwardRegressionLearnerNodeView.class);
     ...
     * Creates a new view.
     *
     * @param nodeModel The model (class: {@link FeedforwardRegressionLearnerNodeModel})
     */
