...
public abstract class AbstractDLNodeModel extends NodeModel {
     ...
     */
    protected void logWarnings(final NodeLogger logger, List<String> warnings){
     ...
     */
    protected void logDebug(final NodeLogger logger, List<String> debug){
    	for(String w : debug){
    		if(w != null && !w.isEmpty()){
    			logger.debug(w);
    		}
	...
	protected void setSettingsModels(List<SettingsModel> m_settingsModels) {
		this.m_settingsModels = m_settingsModels;
	}
	
	protected void addToSettingsModels(SettingsModel setting){
